...
class IdeConceptsThemePicker extends StatefulWidget {
  ...
  final void Function(int) onAccentIndex;
  final void Function(bool) onHighContrast;
  final void Function(bool) onThemeSyncOs;
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Themes',
                        style: IdeFonts.mono(
                            color: t.text, fontSize: 14, weight: FontWeight.w600)),
                    SwitchListTile(
                      title: Text('High contrast',
                          style: IdeFonts.mono(color: t.text, fontSize: 12)),
                      value: widget.highContrast,
                      onChanged: widget.onHighContrast,
                    ),
                    SwitchListTile(
                      title: Text('Sync with OS',
                          style: IdeFonts.mono(color: t.text, fontSize: 12)),
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: t.resolvedAccentVariants[i],
                                  shape: BoxShape.circle,
                                  border: Border.all(
                                    color: widget.accentIndex == i
                                        ? Colors.white
                                        : Colors.black26,
                                    width: widget.accentIndex == i ? 2 : 1,
                                  ),
                                ),
                              ),
                            ),
                    ...
                    Flexible(
                      child: SingleChildScrollView(
                        child: Wrap(
                          ...
                          runSpacing: 12,
                          children: [
                            for (final e in IdeConceptsThemes.all)
                              GestureDetector(
                    ...
                    Align(
                      ...
                      child: TextButton(
                        ...
                        child:
                            Text('Close', style: IdeFonts.mono(color: t.muted)),
                      ),
                    ),
                  ],
                ),
